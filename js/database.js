...
const DatabaseManager = {
    ...
    clear: () => {
        return new Promise((resolve, reject) => {
            ...
            const deleteRequest = indexedDB.deleteDatabase(AppConfig.DB_NAME);
            ...
            deleteRequest.onblocked = (event) => {
                // When a database deletion is blocked, it means another connection is still open.
                // This is a critical error in a testing environment that can cause tests to hang.
                // We must reject the promise to ensure the test fails fast and provides a clear error.
                console.error('Database deletion blocked. This is likely due to an open connection from a previous test. Please ensure all database connections are closed before resetting.', event);
